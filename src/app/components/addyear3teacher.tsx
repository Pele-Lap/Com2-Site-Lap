...
import { Addteachercontactyear3 } from "../data/getData";

export default function ADDyear3Teacher() {
        ...
        <div className="fixed inset-0 bg-gray-300 bg-opacity-50 flex items-center justify-center z-50 px-4 backdrop-blur-3xl">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-fade-in">
              ...
              <div className="mt-6 flex justify-between">
                ...
                <button
                  onClick={AddteachercontactYear3}
